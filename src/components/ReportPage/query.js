export default `select
  json_extract_scalar(json,'$.name[0].family[0]') as "Family Name",
  json_extract_scalar(json,'$.name[0].given[0]') as "Given Name",
  json_extract_scalar(json,'$.address[0].line[0]') as "Address",
  json_extract_scalar(json,'$.gender') Gender,
  json_extract_scalar(json,'$.birthDate') DOB
from patient p
